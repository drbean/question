...
dic_test = [
 ...
 , "Actually, although the cultural differences are important, they aren't very big."
	 ...
	 , "They are all unique and you need to remember that."
	 , "You need to treat everyone as an individual, not according to your understanding of the cultural group."
