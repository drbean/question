...
yn_dic_test = [
  ...
  , "If Fast-Track chooses Eva, does Eva want to start improving Fast-Track's sales team?"
  ...
  , "Does Eva think that Fast-Track can get good results, if people help each other?"
