...
dic_test = [
  ...
  , "If Barbara gets the job, Barbara thinks she can become a director in a few years' time."
  , "Barbara really wants to become a director."
  , "Becoming a director is what Barbara really wants."
  , "Barbara applies for the job because she thinks she has a lot to offer."
  , "Barbara is competitive."
  , "Barbara likes to win."
  , "Barbara knows that a few people think Barbara is difficult to work with."
  , "Maybe it's true that Barbara is difficult to work with."
  , "Barbara gets results."
  , "Barbara thinks results are the main thing."
  ...
  , "Eva thinks Fast-Track can get good results, if people help each other."
  , "Eva has a lot of sales experience."
  , "Eva is successful."
  , "Eva thinks she can lead a team well."
