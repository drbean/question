...
dic_test = [
  ...
  , "If things are not going according to the plan, you should change what you are doing or change the plan."
...
yn_dic_test = [
  ...
  , "Do you need to know what to do each day?"
  , "Should you have a schedule you can look at to see how you are going today, this month and this year?"
  , "Are things going according to the plan?"
  , "If things are not going according to the plan, should you change what you are doing or change the plan?"
...
wh_dic_test = [
  ...
  , "What do you need to know each day?"
  , "What should you have to look at to see how you are going today, this month and this year?"
  , "What are things going according to?"
  , "If things are not going according to the plan, What should you do?"
