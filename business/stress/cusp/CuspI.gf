...
lin
  ...
  approachability	= mkCN approachability_N;
  area	= mkCN area_N;
  assessment	= mkCN assessment_N;
  awareness	= mkCN awareness_N;
  ...
  flexibility	= mkCN flexibility_N;
  framework	= mkCN framework_N;
  group	= mkCN group_N;
  health	= mkCN health_N;
  ...
  model	= mkCN model_N;
  one	= mkCN one_N;
  openness	= mkCN openness_N;
  option	= mkCN option_N;
  overview	= mkCN overview_N;
  people	= mkCN people_N;
  performance	= mkCN performance_N;
  placement	= mkCN placement_N;
  plan	= mkCN plan_N;
  position	= mkCN position_N;
  problem	= mkCN problem_N;
  responsibility	= mkCN responsibility_N;
  risk	= mkCN risk_N;
  sense	= sense_N2;
