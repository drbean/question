...
oper
	...
	bad_AP	= mkAP "bad";
	best_AP	= mkAP "best";
	best_placed_AP	= mkAP "best-placed";
	better_AP	= mkAP "better";
	brief_AP	= mkAP "brief";
	common_AP	= mkAP "common";
	critically_important_AP	= mkAP "critically-important";
	day_to_day_AP	= mkAP "day-to-day";
	difficult_AP	= mkAP "difficult";
	effective_AP	= mkAP "effective";
	face_to_face_AP	= mkAP "face-to-face";
	good_AP	= mkAP "good";
