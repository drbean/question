...
dic_test = [
	...
	"The Al Smith dinner is the last time the presidential candidates meet before the election."
	, "The dinner, which is a Catholic event, raises more than six million dollars."
	...
	, "This year the ribbing is nasty."
	, "Trump says Clinton believes it is vital to have a public policy and a totally different private policy."
	, "Trump says Clinton pretends not to hate Catholics."
	, "Clinton says Trump thinks the Statue of Liberty needs to lose the torch."
	, "Clinton says Trump thinks the Statue of Liberty needs to change her hair."
	, "It is clear that they despise each other at a level rarely seen in national politics."
