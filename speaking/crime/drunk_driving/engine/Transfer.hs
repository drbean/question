...
main = do
	path <- getProgPath
	gr <- readPGF ( path ++ "/Drunk_driving.pgf" )
	hClose stderr
...
takeAnswer "none" _ = "none of Mrs Tipton"
takeAnswer _ "none" = "none of Mrs Tipton"
takeAnswer "No answer" _ = "No answer"
takeAnswer _ "No answer" = "No answer"
takeAnswer _  _   = error "undefined answer, not Yes, No, Mrs Tipton, none or No answer"
