...
yn_dic_test = [
  ...
  , "Doesn't Annie ask a stranger where he is from?"
  , "Doesn't a stranger ask Annie where she is from?"
  , "Doesn't Annie ask a stranger if he is male or female?"
  , "Doesn't a stranger ask Annie if she is male or female?"
  , "Does Annie tell a stranger that she is from Taiwan?"
  , "Does a stranger tell Annie that he is from Taiwan?"
  , "Does Annie ask a stranger if she is a student?"
  ...
  , "Doesn't Cheney ask Jack if he is male or female?"
  , "Does Jack ask Cheney if he is male or female?"
  , "Does Cheney tell Jack he is male?"
  , "Does Jack tell Cheney he is male?"
  ...
  , "Does Cheney tell Jack that he is 19?"
	...
	, "Doesn't Stefan greet Andy?"
  , "Does Andy ask Stefan where he is from?"
  , "Does Stefan ask Andy where he is from?"
  , "Doesn't Andy ask Stefan if he is male or female?"
  , "Doesn't Stefan ask Andy if he is male or female?"
  , "Does Andy tell Stefan that he is from Taiwan?"
  , "Does Stefan tell Andy that he is from Hungary?"
  , "Doesn't Stefan tell Andy that he is from Taiwan?"
  , "Does Andy ask Stefan if he is a student?"
  , "Doesn't Stefan ask Andy if he is a student?"
  , "Does Stefan tell Andy that he is a student?"
  , "Does Andy ask Stefan how old he is?"
  , "Doesn't Stefan ask Andy how old he is?"
