...
yn_dic_test = [
  ...
  , "Does a stranger tell Dora that he is from Taiwan?"
	...
	, "Does Cherry1 greet a stranger?"
	, "Does a stranger greet Cherry1?"
  , "Does Cherry1 ask a stranger where he is from?"
  , "Does a stranger ask Cherry1 where she is from?"
  , "Does Cherry1 ask a stranger how old he is?"
  , "Does a stranger ask Cherry1 how old she is?"
  , "Does Cherry1 ask a stranger if he is a girl or a boy?"
  , "Does a stranger ask Cherry1 if she is a girl or a boy?"
  , "Does Cherry1 tell a stranger that she is from Taiwan?"
  , "Does a stranger tell Cherry1 that he is a student?"
  , "Does a stranger tell Cherry1 that he is from Taiwan?"
	, "Does a stranger ask Cherry1 if she is a student?"
	, "Does a stranger ask Cherry1 if she is in the class?"
  , "Does a stranger tell Cherry1 that he is 16?"
  , "Does a stranger tell Cherry1 that he is from Romania?"
  ...
  , "Does Demi ask a stranger if he is male or female?"
  , "Does a stranger ask Demi if she is male or female?"
  , "Does Demi tell a stranger that she is from Taiwan?"
  , "Does a stranger tell Demi that he is from the US?"

	, "Does Lisa1 greet a stranger?"
	, "Does a stranger greet Lisa1?"
  , "Does Lisa1 ask a stranger where he is from?"
  , "Does a stranger ask Lisa1 where she is from?"
  , "Does Lisa1 ask a stranger if he is male or female?"
  , "Does a stranger ask Lisa1 if she is male or female?"
  , "Does Lisa1 tell a stranger that she is from Taiwan?"
  , "Does a stranger tell Lisa1 that he is from the US?"
