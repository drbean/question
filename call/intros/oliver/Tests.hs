...
student_test = [
	...
	, "Oliver's Chinese name is Pan YanMin, isn't it?"
	, "Oliver's Chinese name is Pan YanMin, isnt' it?"
	, "Pan YanMin is whose Chinese name?"
	, "Was Oliver born in Taipei"
	, "Was Oliver born in Taipei?"
	, "Who has an older sister?"
	, "Who is the person who has an older sister?"
	, "Who is the student whose has an older sister?"
	, "Who loves listening to music?"
	, "Whose Chinese name is Pan YanMin?"
	, "Who studies in Kainan University?"
	, "Are he listening to music?"
	, "Can he play baseball?"
	, "Can he play baseball/"
	, "Did Oliver born in Taipei?"
	, "Does his older sister have a mother?"
	, "Does Oliver a happy person?"
	, "Does Oliver a happy person fdsdf fdsdsf fdsds?"
	, "Does Oliver born in Taipei?"
	, "Does Oliver happy?"
	, "Does Oliver have a Chinese name?"
	, "Does Oliver have a girlfriend?"
	, "Does Oliver have a older sister?"
	, "Does Oliver have a sister?"
	, "Does Oliver is happy?"
	, "Does Oliver like music?"
	, "Does Oliver like to listen to music?"
