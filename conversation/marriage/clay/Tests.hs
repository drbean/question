...
yn_dic_test = [
	...
	, "Does Frank go down to City Hall?"
	, "Does Rebia go down to City Hall?"
	, "Do Frank and Rebia go down to City Hall?"
	, "Do Frank and Rebia get married?"
	...
	, "Does Frank give Rebia his class ring?"
	, "Does Frank try to give Rebia his class ring?"
	, "Is the class ring big?"
	, "Is the class ring ugly?"
	-- , "Does Frank try to put his class ring on Rebia's finger?"
	...
	, "Is there a ring box on the dresser?"
	...
	, "Does Frank get into a altercation?"
