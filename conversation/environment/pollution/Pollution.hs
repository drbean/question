...
data GAdv_result =
   GCloseAdv_result GConj GListAdv_result 
 | GResulting GResultPrep GNP 
  deriving Show
...
data GListAdv_result =
   GAddAdv_result GAdv_result GListAdv_result 
 | GAdv_resultList GAdv_result GAdv_result 
  deriving Show
...
instance Gf GAP where
  ...
  gf Gavox = mkApp (mkCId "avox") []
  gf Gbad = mkApp (mkCId "bad") []
  gf Gdead = mkApp (mkCId "dead") []
  gf Genvironmental = mkApp (mkCId "environmental") []
  gf Ghuge = mkApp (mkCId "huge") []
  gf Gother = mkApp (mkCId "other") []
  gf Gterrible = mkApp (mkCId "terrible") []
  gf Gunderground = mkApp (mkCId "underground") []
  gf Gurban = mkApp (mkCId "urban") []
  ...
  fg t =
    case unApp t of
      ...
      Just (i,[]) | i == mkCId "avox" -> Gavox 
      Just (i,[]) | i == mkCId "bad" -> Gbad 
      Just (i,[]) | i == mkCId "dead" -> Gdead 
      Just (i,[]) | i == mkCId "environmental" -> Genvironmental 
      Just (i,[]) | i == mkCId "huge" -> Ghuge 
      Just (i,[]) | i == mkCId "other" -> Gother 
      Just (i,[]) | i == mkCId "terrible" -> Gterrible 
      Just (i,[]) | i == mkCId "underground" -> Gunderground 
      Just (i,[]) | i == mkCId "urban" -> Gurban 
...
instance Gf GAdv_result where
  gf (GCloseAdv_result x1 x2) = mkApp (mkCId "CloseAdv_result") [gf x1, gf x2]
  gf (GResulting x1 x2) = mkApp (mkCId "Resulting") [gf x1, gf x2]

  fg t =
    case unApp t of
      Just (i,[x1,x2]) | i == mkCId "CloseAdv_result" -> GCloseAdv_result (fg x1) (fg x2)
...
instance Gf GCN where
  ...
  gf Gamount = mkApp (mkCId "amount") []
  gf Gareas = mkApp (mkCId "areas") []
  gf Gbird = mkApp (mkCId "bird") []
  gf Gbuilding = mkApp (mkCId "building") []
  gf Gchemical = mkApp (mkCId "chemical") []
  gf Gcompany = mkApp (mkCId "company") []
  gf Gentity = mkApp (mkCId "entity") []
  gf Genvironment = mkApp (mkCId "environment") []
  gf Gfactory = mkApp (mkCId "factory") []
  gf Gfish = mkApp (mkCId "fish") []
  gf Glaw = mkApp (mkCId "law") []
  gf Goil_spill = mkApp (mkCId "oil_spill") []
  gf Gperson = mkApp (mkCId "person") []
  gf Gplant = mkApp (mkCId "plant") []
  gf Grain_forest = mkApp (mkCId "rain_forest") []
  gf Griver = mkApp (mkCId "river") []
  gf Gstatue = mkApp (mkCId "statue") []
  gf Gstory = mkApp (mkCId "story") []
  gf Gsuburb = mkApp (mkCId "suburb") []
  gf Gthing = mkApp (mkCId "thing") []
  gf Gtop_executive = mkApp (mkCId "top_executive") []
  gf Gtv_station = mkApp (mkCId "tv_station") []
  ...
  fg t =
    case unApp t of
      ...
      Just (i,[]) | i == mkCId "amount" -> Gamount 
      Just (i,[]) | i == mkCId "areas" -> Gareas 
      Just (i,[]) | i == mkCId "bird" -> Gbird 
      Just (i,[]) | i == mkCId "building" -> Gbuilding 
      Just (i,[]) | i == mkCId "chemical" -> Gchemical 
      Just (i,[]) | i == mkCId "company" -> Gcompany 
      Just (i,[]) | i == mkCId "entity" -> Gentity 
      Just (i,[]) | i == mkCId "environment" -> Genvironment 
      Just (i,[]) | i == mkCId "factory" -> Gfactory 
      Just (i,[]) | i == mkCId "fish" -> Gfish 
      Just (i,[]) | i == mkCId "law" -> Glaw 
      Just (i,[]) | i == mkCId "oil_spill" -> Goil_spill 
      Just (i,[]) | i == mkCId "person" -> Gperson 
      Just (i,[]) | i == mkCId "plant" -> Gplant 
      Just (i,[]) | i == mkCId "rain_forest" -> Grain_forest 
      Just (i,[]) | i == mkCId "river" -> Griver 
      Just (i,[]) | i == mkCId "statue" -> Gstatue 
      Just (i,[]) | i == mkCId "story" -> Gstory 
      Just (i,[]) | i == mkCId "suburb" -> Gsuburb 
      Just (i,[]) | i == mkCId "thing" -> Gthing 
      Just (i,[]) | i == mkCId "top_executive" -> Gtop_executive 
      Just (i,[]) | i == mkCId "tv_station" -> Gtv_station 
...
instance Gf GDet where
  ...
  gf Ga_lot_of = mkApp (mkCId "a_lot_of") []
  ...
  fg t =
    case unApp t of
      ...
      Just (i,[]) | i == mkCId "a_lot_of" -> Ga_lot_of 
...
instance Gf GListAdv_result where
  gf (GAddAdv_result x1 x2) = mkApp (mkCId "AddAdv_result") [gf x1, gf x2]
  gf (GAdv_resultList x1 x2) = mkApp (mkCId "Adv_resultList") [gf x1, gf x2]

  fg t =
    case unApp t of
      Just (i,[x1,x2]) | i == mkCId "AddAdv_result" -> GAddAdv_result (fg x1) (fg x2)
      Just (i,[x1,x2]) | i == mkCId "Adv_resultList" -> GAdv_resultList (fg x1) (fg x2)


      _ -> error ("no ListAdv_result " ++ show t)
...
instance Gf GN where
  ...
  gf Gacid_rain = mkApp (mkCId "acid_rain") []
  gf Gair = mkApp (mkCId "air") []
  gf Gair_pollution = mkApp (mkCId "air_pollution") []
  gf Gdestruction = mkApp (mkCId "destruction") []
  gf Gextinction = mkApp (mkCId "extinction") []
  gf Gfarmland = mkApp (mkCId "farmland") []
  gf Gmanagement = mkApp (mkCId "management") []
  gf Gmarine_life = mkApp (mkCId "marine_life") []
  gf Gpollution = mkApp (mkCId "pollution") []
  gf Gsoil = mkApp (mkCId "soil") []
  gf Gtown = mkApp (mkCId "town") []
  gf Gwater = mkApp (mkCId "water") []
  gf Gwater_pollution = mkApp (mkCId "water_pollution") []
  gf Gwildlife = mkApp (mkCId "wildlife") []
  ...
  fg t =
    case unApp t of
      ...
      Just (i,[]) | i == mkCId "acid_rain" -> Gacid_rain 
      Just (i,[]) | i == mkCId "air" -> Gair 
      Just (i,[]) | i == mkCId "air_pollution" -> Gair_pollution 
      Just (i,[]) | i == mkCId "destruction" -> Gdestruction 
      Just (i,[]) | i == mkCId "extinction" -> Gextinction 
      Just (i,[]) | i == mkCId "farmland" -> Gfarmland 
      Just (i,[]) | i == mkCId "management" -> Gmanagement 
      Just (i,[]) | i == mkCId "marine_life" -> Gmarine_life 
      Just (i,[]) | i == mkCId "pollution" -> Gpollution 
      Just (i,[]) | i == mkCId "soil" -> Gsoil 
      Just (i,[]) | i == mkCId "town" -> Gtown 
      Just (i,[]) | i == mkCId "water" -> Gwater 
      Just (i,[]) | i == mkCId "water_pollution" -> Gwater_pollution 
      Just (i,[]) | i == mkCId "wildlife" -> Gwildlife 


      _ -> error ("no N " ++ show t)

instance Gf GN2 where
  gf Ggrowth = mkApp (mkCId "growth") []
  gf Ghealth = mkApp (mkCId "health") []
  gf Gway = mkApp (mkCId "way") []

  fg t =
    case unApp t of
      Just (i,[]) | i == mkCId "growth" -> Ggrowth 
      Just (i,[]) | i == mkCId "health" -> Ghealth 
...
instance Gf GPN where
  gf Gandy = mkApp (mkCId "andy") []
  gf Gavox_industries = mkApp (mkCId "avox_industries") []
  gf Gcarla = mkApp (mkCId "carla") []

  fg t =
    case unApp t of
      Just (i,[]) | i == mkCId "andy" -> Gandy 
      Just (i,[]) | i == mkCId "avox_industries" -> Gavox_industries 
      Just (i,[]) | i == mkCId "carla" -> Gcarla 
...
instance Gf GPrep where
  ...
  gf Gagainst = mkApp (mkCId "against") []
  ...
  gf Goutside = mkApp (mkCId "outside") []
  ...
  fg t =
    case unApp t of
      ...
      Just (i,[]) | i == mkCId "against" -> Gagainst 
      ...
      Just (i,[]) | i == mkCId "outside" -> Goutside 
...
instance Gf GV where
  gf Geat_up = mkApp (mkCId "eat_up") []
  gf Ghappen = mkApp (mkCId "happen") []
  gf Gpublicity = mkApp (mkCId "publicity") []
  gf Gwork = mkApp (mkCId "work") []

  fg t =
    case unApp t of
      Just (i,[]) | i == mkCId "eat_up" -> Geat_up 
      Just (i,[]) | i == mkCId "happen" -> Ghappen 
      Just (i,[]) | i == mkCId "publicity" -> Gpublicity 
...
instance Gf GV2 where
  gf Gaccelerate = mkApp (mkCId "accelerate") []
  gf Gchange = mkApp (mkCId "change") []
  gf Gcontaminate = mkApp (mkCId "contaminate") []
  gf Gerode = mkApp (mkCId "erode") []
  gf Gharm = mkApp (mkCId "harm") []
  gf Ghate = mkApp (mkCId "hate") []
  gf Ghave = mkApp (mkCId "have") []
  gf Gignore = mkApp (mkCId "ignore") []
  gf Gkill = mkApp (mkCId "kill") []
  gf Gknow_V2 = mkApp (mkCId "know_V2") []
  gf Gpollute = mkApp (mkCId "pollute") []
  gf Grun = mkApp (mkCId "run") []
  gf Gsee = mkApp (mkCId "see") []
  gf Gtalk = mkApp (mkCId "talk") []
  gf Gthreaten = mkApp (mkCId "threaten") []

  fg t =
    case unApp t of
      Just (i,[]) | i == mkCId "accelerate" -> Gaccelerate 
      Just (i,[]) | i == mkCId "change" -> Gchange 
      Just (i,[]) | i == mkCId "contaminate" -> Gcontaminate 
      Just (i,[]) | i == mkCId "erode" -> Gerode 
      Just (i,[]) | i == mkCId "harm" -> Gharm 
      Just (i,[]) | i == mkCId "hate" -> Ghate 
      Just (i,[]) | i == mkCId "have" -> Ghave 
      Just (i,[]) | i == mkCId "ignore" -> Gignore 
      Just (i,[]) | i == mkCId "kill" -> Gkill 
      Just (i,[]) | i == mkCId "know_V2" -> Gknow_V2 
      Just (i,[]) | i == mkCId "pollute" -> Gpollute 
      Just (i,[]) | i == mkCId "run" -> Grun 
      Just (i,[]) | i == mkCId "see" -> Gsee 
      Just (i,[]) | i == mkCId "talk" -> Gtalk 
      Just (i,[]) | i == mkCId "threaten" -> Gthreaten 
...
instance Gf GV3 where
  gf Gpump = mkApp (mkCId "pump") []

  fg t =
    case unApp t of
      Just (i,[]) | i == mkCId "pump" -> Gpump 
